...
extern "C" {
    ...
    //inline void ThreadUseInterrupt(enum IRQ_NUMBER_t interruptName);
#ifdef __cplusplus
}
#endif
...
//////////////////////////////////////////////////////////////////////
// Thread locking routines, inspired by PJRC.com SPI transactions.
//////////////////////////////////////////////////////////////////////
...
//-----------------------------------------------------------------------
extern inline void ThreadUseInterrupt( enum IRQ_NUMBER_t interruptName ) {
...
typedef struct {
    ...
    volatile thread_func_t func_to_ptr;
    volatile thread_func_t func_from_ptr;
} thread_msg_t;
//////////////////////////////////////////////////////////////////////
// Thread Struct - save register
//////////////////////////////////////////////////////////////////////
enum ThreadState {
    ThreadCreated,	// thread created, but not yet started
    ThreadPause,	    // thread is paused
    ThreadExecuting,	// thread is executing
    ThreadReturned,	// thread has terminated
    ThreadInvalid		// thread is invalid 
};
